...
import { FolderGit2, ExternalLink, ArrowUpRight, HardDrive, Sparkles, FolderOpen, Edit3, Check, FolderSearch, Camera, Globe } from 'lucide-react';
...
export const Projects: React.FC<ProjectsProps> = ({ 
  ...
  const { projects, personalInfo } = usePortfolioContent();
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto justify-end flex-wrap">
                    {project.projectUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 px-3 py-2 rounded-lg transition-colors min-h-[38px]"
                        title="Ouvrir le lien du projet"
                      >
